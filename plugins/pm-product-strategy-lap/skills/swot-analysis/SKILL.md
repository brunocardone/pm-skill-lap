    ---
    name: swot-analysis
    description: Analyze strengths, weaknesses, opportunities, and threats and convert them into strategic actions. Use when the user asks about strategy scan, executive update, planning. This skill is part of the Product Strategy plugin in PM Skill LAP.
    ---

    # Swot Analysis

    ## Purpose
    Analyze strengths, weaknesses, opportunities, and threats and convert them into strategic actions.
