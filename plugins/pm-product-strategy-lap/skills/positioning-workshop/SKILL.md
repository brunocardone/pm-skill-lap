    ...
    description: Run a workshop to align target customer, category, differentiated value, and proof. Use when the user asks about positioning workshop, stakeholder alignment, messaging ambiguity. This skill is part of the Product Strategy plugin in PM Skill LAP.
    ---

    # Positioning Workshop

    ## Purpose
    Run a workshop to align target customer, category, differentiated value, and proof.
