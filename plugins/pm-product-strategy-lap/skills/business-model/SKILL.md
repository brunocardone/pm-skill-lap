    ---
    name: business-model
    description: Map the 9 building blocks of a business model and the assumptions connecting them. Use when the user asks about business model, platform strategy, new business. This skill is part of the Product Strategy plugin in PM Skill LAP.
    ---

    # Business Model

    ## Purpose
    Map the 9 building blocks of a business model and the assumptions connecting them.
