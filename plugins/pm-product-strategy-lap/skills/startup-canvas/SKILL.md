    ---
    name: startup-canvas
    description: Combine product strategy and business model thinking for a zero-to-one product or startup. Use when the user asks about new venture, startup idea, incubation. This skill is part of the Product Strategy plugin in PM Skill LAP.
    ---

    # Startup Canvas

    ## Purpose
    Combine product strategy and business model thinking for a zero-to-one product or startup.
