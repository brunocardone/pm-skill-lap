    ...
    description: Design a JTBD-centered value proposition across who, why, before, after, alternative, and differentiation. Use when the user asks about value prop, landing page, sales narrative. This skill is part of the Product Strategy plugin in PM Skill LAP.
    ---

    # Value Proposition

    ## Purpose
    Design a JTBD-centered value proposition across who, why, before, after, alternative, and differentiation.
