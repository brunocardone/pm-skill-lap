    ...
    description: Analyze political, economic, social, technological, environmental, and legal forces. Use when the user asks about macro environment, market entry, strategy scan. This skill is part of the Product Strategy plugin in PM Skill LAP.
    ---
...
Produce a structured artifact with: context, assumptions, framework application, table or canvas where useful, recommendation, risks, open questions, and next action.
    ...
    This LAP skill consolidates: `pestle-analysis`.
