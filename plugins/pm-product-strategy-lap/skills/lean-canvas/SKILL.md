    ---
    name: lean-canvas
    description: Create a Lean Canvas for startups and new products with problem, solution, metrics, unfair advantage, channels, costs, and revenue. Use when the user asks about startup model, business validation, early pitch. This skill is part of the Product Strategy plugin in PM Skill LAP.
    ---

    # Lean Canvas

    ## Purpose
    Create a Lean Canvas for startups and new products with problem, solution, metrics, unfair advantage, channels, costs, and revenue.
