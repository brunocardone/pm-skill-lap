    ...
    description: Create a Geoffrey Moore-style positioning statement with target customer, need, category, benefit, and differentiation. Use when the user asks about positioning, messaging, launch narrative. This skill is part of the Product Strategy plugin in PM Skill LAP.
    ---

    # Positioning Statement

    ## Purpose
    Create a Geoffrey Moore-style positioning statement with target customer, need, category, benefit, and differentiation.
...
Produce a structured artifact with: context, assumptions, framework application, table or canvas where useful, recommendation, risks, open questions, and next action.
    ...
    This LAP skill consolidates: `positioning-ideas`.
