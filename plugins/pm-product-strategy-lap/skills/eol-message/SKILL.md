    ---
    name: eol-message
    description: Write a clear, empathetic product sunset or end-of-life message with rationale, timeline, migration, and support path. Use when the user asks about product sunset, deprecation, customer comms. This skill is part of the Product Strategy plugin in PM Skill LAP.
    ---

    # Eol Message

    ## Purpose
    Write a clear, empathetic product sunset or end-of-life message with rationale, timeline, migration, and support path.
