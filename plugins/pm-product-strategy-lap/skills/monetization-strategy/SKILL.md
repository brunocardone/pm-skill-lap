    ...
    description: Generate and evaluate monetization paths, packaging options, validation tests, and tradeoffs. Use when the user asks about monetization, pricing exploration, revenue design. This skill is part of the Product Strategy plugin in PM Skill LAP.
    ---

    # Monetization Strategy

    ## Purpose
    Generate and evaluate monetization paths, packaging options, validation tests, and tradeoffs.
