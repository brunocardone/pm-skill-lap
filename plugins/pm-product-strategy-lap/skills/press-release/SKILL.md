    ---
    name: press-release
    description: Write an Amazon-style working-backwards press release before build. Use when the user asks about working backwards, new product definition, executive narrative. This skill is part of the Product Strategy plugin in PM Skill LAP.
    ---

    # Press Release

    ## Purpose
    Write an Amazon-style working-backwards press release before build.
