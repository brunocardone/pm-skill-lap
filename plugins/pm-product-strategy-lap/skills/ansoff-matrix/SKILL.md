    ---
    name: ansoff-matrix
    description: Map growth options across market penetration, market development, product development, and diversification. Use when the user asks about growth strategy, portfolio planning, market expansion. This skill is part of the Product Strategy plugin in PM Skill LAP.
    ---

    # Ansoff Matrix

    ## Purpose
    Map growth options across market penetration, market development, product development, and diversification.
