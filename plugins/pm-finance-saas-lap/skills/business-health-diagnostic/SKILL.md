    ...
    description: Diagnose SaaS health across growth, retention, efficiency, margin, concentration, and capital. Use when the user asks about SaaS health, board update, business review. This skill is part of the Finance & SaaS Economics plugin in PM Skill LAP.
    ---

    # Business Health Diagnostic

    ## Purpose
    Diagnose SaaS health across growth, retention, efficiency, margin, concentration, and capital.
