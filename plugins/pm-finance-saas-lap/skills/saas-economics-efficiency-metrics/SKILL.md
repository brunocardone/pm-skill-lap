    ...
    description: Evaluate CAC, LTV, payback, magic number, burn multiple, and capital efficiency. Use when the user asks about unit economics, capital efficiency, growth investment. This skill is part of the Finance & SaaS Economics plugin in PM Skill LAP.
    ---

    # SaaS Economics Efficiency Metrics

    ## Purpose
    Evaluate CAC, LTV, payback, magic number, burn multiple, and capital efficiency.
