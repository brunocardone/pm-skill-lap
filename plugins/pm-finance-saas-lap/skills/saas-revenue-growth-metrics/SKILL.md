    ...
    description: Calculate and interpret ARR, MRR, NRR, GRR, churn, expansion, contraction, and growth momentum. Use when the user asks about revenue metrics, retention metrics, growth review. This skill is part of the Finance & SaaS Economics plugin in PM Skill LAP.
    ---

    # SaaS Revenue Growth Metrics

    ## Purpose
    Calculate and interpret ARR, MRR, NRR, GRR, churn, expansion, contraction, and growth momentum.
