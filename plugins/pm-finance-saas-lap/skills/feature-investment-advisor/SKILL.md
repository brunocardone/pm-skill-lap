    ...
    description: Evaluate feature investments using revenue impact, cost, ROI, retention, strategic value, and option value. Use when the user asks about feature ROI, investment decision, roadmap tradeoff. This skill is part of the Finance & SaaS Economics plugin in PM Skill LAP.
    ---

    # Feature Investment Advisor

    ## Purpose
    Evaluate feature investments using revenue impact, cost, ROI, retention, strategic value, and option value.
