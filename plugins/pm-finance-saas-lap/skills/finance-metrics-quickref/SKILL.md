    ...
    description: Look up SaaS finance metrics, formulas, interpretation, and decision implications. Use when the user asks about SaaS metrics, finance vocabulary, board metrics. This skill is part of the Finance & SaaS Economics plugin in PM Skill LAP.
    ---

    # Finance Metrics Quickref

    ## Purpose
    Look up SaaS finance metrics, formulas, interpretation, and decision implications.
