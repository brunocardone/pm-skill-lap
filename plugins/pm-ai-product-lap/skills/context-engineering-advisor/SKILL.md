    ...
    description: Diagnose context stuffing versus context engineering in AI workflows and design better context systems. Use when the user asks about LLM workflow, agent context, AI quality. This skill is part of the AI Product Management plugin in PM Skill LAP.
    ---

    # Context Engineering Advisor

    ## Purpose
    Diagnose context stuffing versus context engineering in AI workflows and design better context systems.
