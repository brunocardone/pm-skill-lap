    ---
    name: growth-loops
    description: Design sustainable growth loops and flywheels with actors, triggers, reinforcement, metrics, and failure points. Use when the user asks about growth loop, flywheel, PLG. This skill is part of the Go-to-Market plugin in PM Skill LAP.
    ---

    # Growth Loops

    ## Purpose
    Design sustainable growth loops and flywheels with actors, triggers, reinforcement, metrics, and failure points.
