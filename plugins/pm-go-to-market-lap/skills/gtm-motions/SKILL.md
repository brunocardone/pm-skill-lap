    ---
    name: gtm-motions
    description: Evaluate product-led, sales-led, partner-led, community-led, and hybrid GTM motions. Use when the user asks about GTM motion choice, sales vs PLG, channel strategy. This skill is part of the Go-to-Market plugin in PM Skill LAP.
    ---

    # GTM Motions

    ## Purpose
    Evaluate product-led, sales-led, partner-led, community-led, and hybrid GTM motions.
