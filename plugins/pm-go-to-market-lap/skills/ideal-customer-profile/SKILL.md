    ...
    description: Define ICP with firmographics, behaviors, JTBD, buying triggers, disqualifiers, and proof points. Use when the user asks about ICP, sales enablement, GTM targeting. This skill is part of the Go-to-Market plugin in PM Skill LAP.
    ---

    # Ideal Customer Profile

    ## Purpose
    Define ICP with firmographics, behaviors, JTBD, buying triggers, disqualifiers, and proof points.
