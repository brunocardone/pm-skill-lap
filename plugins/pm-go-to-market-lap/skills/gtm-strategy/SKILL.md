    ---
    name: gtm-strategy
    description: Design a go-to-market strategy across audience, beachhead, motion, channel, messaging, launch plan, metrics, and risks. Use when the user asks about GTM planning, launch strategy, market entry. This skill is part of the Go-to-Market plugin in PM Skill LAP.
    ---

    # GTM Strategy

    ## Purpose
    Design a go-to-market strategy across audience, beachhead, motion, channel, messaging, launch plan, metrics, and risks.
