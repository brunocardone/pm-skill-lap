    ...
    description: Select a first market segment using pain, urgency, reachability, willingness to pay, competition, and strategic leverage. Use when the user asks about beachhead choice, ICP narrowing. This skill is part of the Go-to-Market plugin in PM Skill LAP.
    ---

    # Beachhead Segment

    ## Purpose
    Select a first market segment using pain, urgency, reachability, willingness to pay, competition, and strategic leverage.
