    ...
    description: Evaluate acquisition channels using unit economics, quality, scalability, speed, and strategic fit. Use when the user asks about acquisition strategy, channel selection, growth planning. This skill is part of the Go-to-Market plugin in PM Skill LAP.
    ---

    # Acquisition Channel Advisor

    ## Purpose
    Evaluate acquisition channels using unit economics, quality, scalability, speed, and strategic fit.
