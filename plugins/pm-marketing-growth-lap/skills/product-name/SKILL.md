    ---
    name: product-name
    description: Brainstorm product names aligned to brand values, audience, category, memorability, and constraints. Use when the user asks about naming, brand work, launch prep. This skill is part of the Marketing & Growth plugin in PM Skill LAP.
    ---

    # Product Name

    ## Purpose
    Brainstorm product names aligned to brand values, audience, category, memorability, and constraints.
