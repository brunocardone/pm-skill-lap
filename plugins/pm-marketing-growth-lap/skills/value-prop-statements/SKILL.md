    ...
    description: Write value proposition statements for marketing, sales, onboarding, website, and internal alignment. Use when the user asks about copywriting, sales narrative, landing page. This skill is part of the Marketing & Growth plugin in PM Skill LAP.
    ---

    # Value Prop Statements

    ## Purpose
    Write value proposition statements for marketing, sales, onboarding, website, and internal alignment.
