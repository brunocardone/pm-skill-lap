    ...
    description: Brainstorm creative, practical, low-cost marketing ideas with audiences, channels, messages, effort, and expected learning. Use when the user asks about marketing brainstorm, campaign ideas, low-budget growth. This skill is part of the Marketing & Growth plugin in PM Skill LAP.
    ---

    # Marketing Ideas

    ## Purpose
    Brainstorm creative, practical, low-cost marketing ideas with audiences, channels, messages, effort, and expected learning.
