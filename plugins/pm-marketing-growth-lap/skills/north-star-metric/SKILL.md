    ...
    description: Define North Star Metric and input metrics based on product game, user value, business model, and causal logic. Use when the user asks about metric strategy, growth alignment, product health. This skill is part of the Marketing & Growth plugin in PM Skill LAP.
    ---

    # North Star Metric

    ## Purpose
    Define North Star Metric and input metrics based on product game, user value, business model, and causal logic.
