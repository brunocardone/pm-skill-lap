    ...
    description: Analyze feedback themes, sentiment, segments, urgency, and strategic fit. Use when the user asks about NPS comments, reviews, support feedback. This skill is part of the Market Research plugin in PM Skill LAP.
    ---

    # Sentiment Analysis

    ## Purpose
    Analyze feedback themes, sentiment, segments, urgency, and strategic fit.
