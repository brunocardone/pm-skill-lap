    ---
    name: market-sizing
    description: Estimate TAM, SAM, and SOM with top-down and bottom-up logic, assumptions, and caveats. Use when the user asks about market sizing, business case, funding narrative. This skill is part of the Market Research plugin in PM Skill LAP.
    ---

    # Market Sizing

    ## Purpose
    Estimate TAM, SAM, and SOM with top-down and bottom-up logic, assumptions, and caveats.
...
Produce a structured artifact with: context, assumptions, framework application, table or canvas where useful, recommendation, risks, open questions, and next action.
    ...
    This LAP skill consolidates: `tam-sam-som-calculator`.
