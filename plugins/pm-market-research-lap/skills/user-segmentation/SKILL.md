    ...
    description: Segment users from feedback or behavioral data based on needs, jobs, behaviors, and value. Use when the user asks about user research, survey analysis, analytics segmentation. This skill is part of the Market Research plugin in PM Skill LAP.
    ---

    # User Segmentation

    ## Purpose
    Segment users from feedback or behavioral data based on needs, jobs, behaviors, and value.
