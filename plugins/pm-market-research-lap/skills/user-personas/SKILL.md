    ---
    name: user-personas
    description: Create refined user personas from research data, behavioral signals, JTBD, pain points, and adoption context. Use when the user asks about persona creation, research synthesis. This skill is part of the Market Research plugin in PM Skill LAP.
    ---

    # User Personas

    ## Purpose
    Create refined user personas from research data, behavioral signals, JTBD, pain points, and adoption context.
