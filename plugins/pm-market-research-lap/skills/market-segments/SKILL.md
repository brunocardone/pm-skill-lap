    ...
    description: Identify 3-5 customer segments with demographics, firmographics, JTBD, willingness to pay, and product fit. Use when the user asks about segmentation, ICP exploration. This skill is part of the Market Research plugin in PM Skill LAP.
    ---

    # Market Segments

    ## Purpose
    Identify 3-5 customer segments with demographics, firmographics, JTBD, willingness to pay, and product fit.
