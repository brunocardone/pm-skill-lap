    ---
    name: journey-workshop
    description: Run the journey-workshop PM workflow and produce a decision-ready artifact.
  ...
  - next step
    ...
    ## Goal
    Execute /journey-workshop as a structured PM workflow.
