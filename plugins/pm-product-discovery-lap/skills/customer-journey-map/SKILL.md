    ...
    description: Map stages, touchpoints, actions, emotions, pain points, opportunities, and metrics. Use when the user asks about journey mapping, experience diagnosis, service design. This skill is part of the Product Discovery plugin in PM Skill LAP.
    ---

    # Customer Journey Map

    ## Purpose
    Map stages, touchpoints, actions, emotions, pain points, opportunities, and metrics.
