    ---
    name: lean-ux-canvas
    description: Guide a team through Lean UX Canvas v2 to frame problems, assumptions, users, outcomes, and experiments. Use when the user asks about workshop framing, early discovery, assumption mapping. This skill is part of the Product Discovery plugin in PM Skill LAP.
    ---

    # Lean Ux Canvas

    ## Purpose
    Guide a team through Lean UX Canvas v2 to frame problems, assumptions, users, outcomes, and experiments.
