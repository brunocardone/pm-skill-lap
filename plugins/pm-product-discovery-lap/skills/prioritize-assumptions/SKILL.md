    ...
    description: Rank assumptions by impact and uncertainty so the team tests what can kill the idea first. Use when the user asks about too many assumptions, validation planning, MVP definition. This skill is part of the Product Discovery plugin in PM Skill LAP.
    ---

    # Prioritize Assumptions

    ## Purpose
    Rank assumptions by impact and uncertainty so the team tests what can kill the idea first.
