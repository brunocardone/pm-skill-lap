    ...
    description: Facilitate an interactive journey-mapping workshop with prompts, pacing, decisions, and outputs. Use when the user asks about journey workshop, cross-functional facilitation, CX alignment. This skill is part of the Product Discovery plugin in PM Skill LAP.
    ---

    # Customer Journey Mapping Workshop

    ## Purpose
    Facilitate an interactive journey-mapping workshop with prompts, pacing, decisions, and outputs.
