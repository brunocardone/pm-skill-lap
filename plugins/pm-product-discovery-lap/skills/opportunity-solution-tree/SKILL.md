    ...
    description: Build an OST from outcome to opportunities, solutions, and experiments; keep solution bias visible. Use when the user asks about continuous discovery, opportunity mapping, outcome alignment. This skill is part of the Product Discovery plugin in PM Skill LAP.
    ---

    # Opportunity Solution Tree

    ## Purpose
    Build an OST from outcome to opportunities, solutions, and experiments; keep solution bias visible.
