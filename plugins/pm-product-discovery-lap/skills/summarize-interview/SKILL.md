    ...
    description: Turn interview notes or transcript into JTBD, pains, gains, quotes, evidence strength, and next learning actions. Use when the user asks about interview transcript, research notes, customer calls. This skill is part of the Product Discovery plugin in PM Skill LAP.
    ---

    # Summarize Interview

    ## Purpose
    Turn interview notes or transcript into JTBD, pains, gains, quotes, evidence strength, and next learning actions.
