    ---
    name: draft-nda
    description: Draft a basic NDA structure with clauses, assumptions, and legal-review reminders. Use when the user asks about NDA draft, startup template. This skill is part of the PM Toolkit plugin in PM Skill LAP.
    ---

    # Draft Nda

    ## Purpose
    Draft a basic NDA structure with clauses, assumptions, and legal-review reminders.
