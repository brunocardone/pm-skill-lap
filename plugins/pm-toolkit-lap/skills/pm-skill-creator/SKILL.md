    ...
    description: Guide a user through designing a repo-compliant skill from scratch via structured conversation. Use when the user asks about new skill idea, contribution, skill design. This skill is part of the PM Toolkit plugin in PM Skill LAP.
    ---

    # Pm Skill Creator

    ## Purpose
    Guide a user through designing a repo-compliant skill from scratch via structured conversation.
