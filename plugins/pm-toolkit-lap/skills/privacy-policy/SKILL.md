    ---
    name: privacy-policy
    description: Draft a privacy policy outline covering data collection, use, sharing, rights, retention, and compliance reminders. Use when the user asks about privacy policy, startup legal copy. This skill is part of the PM Toolkit plugin in PM Skill LAP.
    ---

    # Privacy Policy

    ## Purpose
    Draft a privacy policy outline covering data collection, use, sharing, rights, retention, and compliance reminders.
