    ...
    description: Turn raw PM content into a compliant, reusable, trigger-ready skill. Use when the user asks about skill creation, repository contribution. This skill is part of the PM Toolkit plugin in PM Skill LAP.
    ---

    # Skill Authoring Workflow

    ## Purpose
    Turn raw PM content into a compliant, reusable, trigger-ready skill.
