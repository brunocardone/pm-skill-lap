    ---
    name: grammar-check
    description: Improve grammar, logic, flow, tone, and structure while preserving intent. Use when the user asks about proofreading, executive memo, product copy. This skill is part of the PM Toolkit plugin in PM Skill LAP.
    ---

    # Grammar Check

    ## Purpose
    Improve grammar, logic, flow, tone, and structure while preserving intent.
