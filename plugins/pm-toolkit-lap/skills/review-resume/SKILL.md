    ---
    name: review-resume
    description: Review and improve a PM resume using impact, clarity, scope, keywords, seniority, and evidence. Use when the user asks about PM resume, career transition. This skill is part of the PM Toolkit plugin in PM Skill LAP.
    ---

    # Review Resume

    ## Purpose
    Review and improve a PM resume using impact, clarity, scope, keywords, seniority, and evidence.
