    ...
    description: Plan a VP or CPO 30-60-90 day diagnostic onboarding path. Use when the user asks about executive onboarding, new leadership role. This skill is part of the Career & Leadership plugin in PM Skill LAP.
    ---

    # Executive Onboarding Playbook

    ## Purpose
    Plan a VP or CPO 30-60-90 day diagnostic onboarding path.
