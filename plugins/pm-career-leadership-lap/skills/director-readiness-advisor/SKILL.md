    ...
    description: Coach a PM preparing for Director-level scope, interviews, and operating model. Use when the user asks about director readiness, career coaching. This skill is part of the Career & Leadership plugin in PM Skill LAP.
    ---

    # Director Readiness Advisor

    ## Purpose
    Coach a PM preparing for Director-level scope, interviews, and operating model.
