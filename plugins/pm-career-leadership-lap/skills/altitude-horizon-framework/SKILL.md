    ...
    description: Understand PM-to-Director transition through altitude, horizon, leverage, and system-level thinking. Use when the user asks about career growth, director transition. This skill is part of the Career & Leadership plugin in PM Skill LAP.
    ---

    # Altitude Horizon Framework

    ## Purpose
    Understand PM-to-Director transition through altitude, horizon, leverage, and system-level thinking.
