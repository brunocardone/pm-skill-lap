    ---
    name: vp-cpo-readiness
    description: Run the vp-cpo-readiness PM workflow and produce a decision-ready artifact.
  ...
  - next step
    ...
    ## Goal
    Execute /vp-cpo-readiness as a structured PM workflow.
