    ---
    name: director-readiness
    description: Run the director-readiness PM workflow and produce a decision-ready artifact.
  ...
  - next step
    ...
    ## Goal
    Execute /director-readiness as a structured PM workflow.
