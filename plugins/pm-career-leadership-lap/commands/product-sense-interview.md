    ...
    description: Run the product-sense-interview PM workflow and produce a decision-ready artifact.
  ...
  - next step
    ...
    ## Goal
    Execute /product-sense-interview as a structured PM workflow.
