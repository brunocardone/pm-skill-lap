    ---
    name: user-stories
    description: Write user stories with 3 Cs, INVEST, acceptance criteria, and testable boundaries. Use when the user asks about backlog creation, story writing, requirements. This skill is part of the Execution & Delivery plugin in PM Skill LAP.
    ---

    # User Stories

    ## Purpose
    Write user stories with 3 Cs, INVEST, acceptance criteria, and testable boundaries.
...
Write stories with the 3 Cs and INVEST. Include persona, job, acceptance criteria, edge cases, analytics events, dependencies, and split suggestions when stories are too large.
    ...
    This LAP skill consolidates: `user-story`.
