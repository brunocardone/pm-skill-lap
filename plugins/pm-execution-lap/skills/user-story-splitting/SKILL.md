    ...
    description: Split large user stories into smaller valuable, testable increments. Use when the user asks about story too large, sprint refinement. This skill is part of the Execution & Delivery plugin in PM Skill LAP.
    ---

    # User Story Splitting

    ## Purpose
    Split large user stories into smaller valuable, testable increments.
