    ...
    description: Frame an epic as a testable hypothesis with user, outcome, expected impact, and validation. Use when the user asks about epic framing, outcome-based delivery. This skill is part of the Execution & Delivery plugin in PM Skill LAP.
    ---

    # Epic Hypothesis

    ## Purpose
    Frame an epic as a testable hypothesis with user, outcome, expected impact, and validation.
