    ...
    description: Break epics into smaller deliverable stories using proven split patterns. Use when the user asks about large epic, backlog slicing, delivery planning. This skill is part of the Execution & Delivery plugin in PM Skill LAP.
    ---

    # Epic Breakdown Advisor

    ## Purpose
    Break epics into smaller deliverable stories using proven split patterns.
