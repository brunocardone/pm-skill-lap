    ...
    description: Create team-level objectives and measurable key results aligned with product and company strategy. Use when the user asks about OKR planning, quarter planning, team alignment. This skill is part of the Execution & Delivery plugin in PM Skill LAP.
    ---

    # Brainstorm OKRs

    ## Purpose
    Create team-level objectives and measurable key results aligned with product and company strategy.
