    ---
    name: retro
    description: Facilitate a retrospective that turns learning into concrete improvement experiments. Use when the user asks about sprint retro, team learning, delivery health. This skill is part of the Execution & Delivery plugin in PM Skill LAP.
    ---

    # Retro

    ## Purpose
    Facilitate a retrospective that turns learning into concrete improvement experiments.
