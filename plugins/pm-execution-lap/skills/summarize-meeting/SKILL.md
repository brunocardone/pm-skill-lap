    ...
    description: Turn meeting notes or transcript into decisions, action items, risks, open questions, and follow-ups. Use when the user asks about meeting notes, decision log, action tracking. This skill is part of the Execution & Delivery plugin in PM Skill LAP.
    ---

    # Summarize Meeting

    ## Purpose
    Turn meeting notes or transcript into decisions, action items, risks, open questions, and follow-ups.
