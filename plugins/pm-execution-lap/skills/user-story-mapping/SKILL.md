    ...
    description: Create a story map with activities, steps, tasks, backbone, release slices, and MVP boundaries. Use when the user asks about story mapping, MVP planning, workshop. This skill is part of the Execution & Delivery plugin in PM Skill LAP.
    ---

    # User Story Mapping

    ## Purpose
    Create a story map with activities, steps, tasks, backbone, release slices, and MVP boundaries.
