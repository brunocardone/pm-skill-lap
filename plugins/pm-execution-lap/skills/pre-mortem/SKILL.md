    ---
    name: pre-mortem
    description: Run a pre-mortem and classify risks as tigers, paper tigers, and elephants with mitigations. Use when the user asks about launch risk, strategy risk, execution risk. This skill is part of the Execution & Delivery plugin in PM Skill LAP.
    ---

    # Pre Mortem

    ## Purpose
    Run a pre-mortem and classify risks as tigers, paper tigers, and elephants with mitigations.
