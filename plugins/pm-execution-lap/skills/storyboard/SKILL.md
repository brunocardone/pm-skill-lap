    ---
    name: storyboard
    description: Create a six-frame storyboard showing a user journey from problem to solution and outcome. Use when the user asks about product narrative, UX concept, stakeholder storytelling. This skill is part of the Execution & Delivery plugin in PM Skill LAP.
    ---

    # Storyboard

    ## Purpose
    Create a six-frame storyboard showing a user journey from problem to solution and outcome.
