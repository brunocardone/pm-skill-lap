    ---
    name: sprint-plan
    description: Plan a sprint with capacity, story selection, risks, dependencies, and definition of done. Use when the user asks about sprint planning, delivery execution. This skill is part of the Execution & Delivery plugin in PM Skill LAP.
    ---

    # Sprint Plan

    ## Purpose
    Plan a sprint with capacity, story selection, risks, dependencies, and definition of done.
