    ---
    name: test-scenarios
    description: Generate happy paths, edge cases, error states, abuse cases, accessibility considerations, and data scenarios. Use when the user asks about QA planning, story validation, acceptance. This skill is part of the Execution & Delivery plugin in PM Skill LAP.
    ---

    # Test Scenarios

    ## Purpose
    Generate happy paths, edge cases, error states, abuse cases, accessibility considerations, and data scenarios.
