    ---
    name: job-stories
    description: Write job stories using situation, motivation, and outcome framing. Use when the user asks about JTBD backlog, behavioral requirements. This skill is part of the Execution & Delivery plugin in PM Skill LAP.
    ---

    # Job Stories

    ## Purpose
    Write job stories using situation, motivation, and outcome framing.
