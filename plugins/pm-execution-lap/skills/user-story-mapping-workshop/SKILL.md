    ...
    description: Run an interactive story-mapping workshop with adaptive prompts and facilitation guidance. Use when the user asks about story map workshop, cross-functional planning. This skill is part of the Execution & Delivery plugin in PM Skill LAP.
    ---

    # User Story Mapping Workshop

    ## Purpose
    Run an interactive story-mapping workshop with adaptive prompts and facilitation guidance.
