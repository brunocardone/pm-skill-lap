    ---
    name: dummy-dataset
    description: Generate realistic dummy datasets as CSV, JSON, SQL, or Python for demos, tests, and analytics examples. Use when the user asks about demo data, test data, analytics mock. This skill is part of the Execution & Delivery plugin in PM Skill LAP.
    ---

    # Dummy Dataset

    ## Purpose
    Generate realistic dummy datasets as CSV, JSON, SQL, or Python for demos, tests, and analytics examples.
