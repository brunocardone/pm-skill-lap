    ...
    description: Analyze retention, feature adoption, engagement, and behavior by cohort. Use when the user asks about retention, activation, cohorts. This skill is part of the Data Analytics plugin in PM Skill LAP.
    ---

    # Cohort Analysis

    ## Purpose
    Analyze retention, feature adoption, engagement, and behavior by cohort.
