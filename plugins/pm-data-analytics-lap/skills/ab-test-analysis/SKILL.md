    ...
    description: Analyze experiment design, significance, sample size, guardrails, and ship/extend/stop recommendation. Use when the user asks about A/B test, experiment result, sample sizing. This skill is part of the Data Analytics plugin in PM Skill LAP.
    ---

    # Ab Test Analysis

    ## Purpose
    Analyze experiment design, significance, sample size, guardrails, and ship/extend/stop recommendation.
