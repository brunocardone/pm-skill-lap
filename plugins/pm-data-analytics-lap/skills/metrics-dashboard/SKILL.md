    ...
    description: Design a product metrics dashboard with North Star, input metrics, guardrails, thresholds, and review cadence. Use when the user asks about dashboard design, metric system, health tracking. This skill is part of the Data Analytics plugin in PM Skill LAP.
    ---

    # Metrics Dashboard

    ## Purpose
    Design a product metrics dashboard with North Star, input metrics, guardrails, thresholds, and review cadence.
