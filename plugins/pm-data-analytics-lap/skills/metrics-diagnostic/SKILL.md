    ...
    description: Diagnose metric symptoms, funnel leaks, retention decay, quality issues, and measurement gaps. Use when the user asks about metric problem, dashboard review, business symptom. This skill is part of the Data Analytics plugin in PM Skill LAP.
    ---

    # Metrics Diagnostic

    ## Purpose
    Diagnose metric symptoms, funnel leaks, retention decay, quality issues, and measurement gaps.
