---
name: wwas
description: Write backlog items in Why-What-Acceptance format to connect purpose, scope, and testability. Use when the user asks about backlog refinement, clear PBIs. This skill is part of the Execution & Delivery plugin in PM Skill LAP.
---

# Why What Acceptance

## Purpose
Write backlog items in Why-What-Acceptance format to connect purpose, scope, and testability.
