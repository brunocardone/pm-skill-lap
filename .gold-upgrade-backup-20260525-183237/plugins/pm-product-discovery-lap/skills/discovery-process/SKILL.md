...
description: Run a complete discovery loop from problem hypothesis to evidence-backed next step. Use when the user asks about full discovery cycle, uncertain idea, new initiative. This skill is part of the Product Discovery plugin in PM Skill LAP.
---

# Discovery Process

## Purpose
Run a complete discovery loop from problem hypothesis to evidence-backed next step.
